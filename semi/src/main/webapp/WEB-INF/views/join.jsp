		...
		<div class="content">
			<form id="joinForm" action="join" method="post">
				...
				<div class="form-group">
					<input type="text" id="m_id" class="join-input" name="m_id"
						placeholder="아이디 (4~15자 영문,숫자)" required>
					<button type="button" class="btn-write" id="checkIdBtn">중복확인</button>
					<span id="id-error-message">${error}</span>
				</div>
				<div class="form-group">
					<input type="password" id="m_pass" class="join-input" name="m_pass"
						placeholder="비밀번호 (8~15자 영문/숫자 또는 특수문자 조합)" required> <span
						id="pw-error-message"></span>
				</div>
				<div class="form-group">
					<input type="password" id="m_passConfirm" class="join-input"
						name="m_passConfirm" placeholder="비밀번호 재입력" required> <span
						id="pw-confirm-error-message"></span>
				</div>
				<div class="form-group">
					<input type="text" id="m_name" class="join-input" name="m_name"
						placeholder="이름" required>
				</div>
				<div class="form-group">
					<input type="date" id="m_birth" class="join-input" name="m_birth"
